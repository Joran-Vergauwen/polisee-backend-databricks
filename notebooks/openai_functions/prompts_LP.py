...
You are trying to figure out if the document contains anything about law proposals.

// HOW TO FIND
As the document is in Dutch and French, the law proposals are typically preceded by words like 'Proposition de loi' and 'Proposition de décret' in French and 'Wetsvoorstel' in Dutch. 

// COUNTING
Count how many times you find a law proposal mentioned in the document. Pay attention though that the files are in Dutch and French. 

// OUTPUT JSON
Then, after you have made your counts, list a JSON that mentions the all the law proposals. 
For example, if you found 3 law proposals, you should list all of them. 
...
// ADDING THE TOPIC
Furthermore, a law proposal can typically also be linked to a topic. 
Try to assign the most relevant topic to the law proposal as shown in the example output. If no topic can be linked, just fill in '/'.
