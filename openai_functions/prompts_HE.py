...
You are trying to figure out if the document contains anything about hearings.

// HOW TO FIND
As the document is in Dutch and French, the hearings are typically preceded by words like “audience” in French and “horing” in Dutch. 

// COUNTING
Count how many times you find a hearing mentioned in the document. 
Pay attention though that the files are in Dutch and French. 

// OUTPUT JSON
Then, after you have made your counts, list a JSON that mentions the all the hearings. 
For example, if you found 3 hearings, you should list all of them. 
...
// ADDING THE TOPIC
Furthermore, a hearing can typically also be linked to a topic. 
Try to assign the most relevant topic to the hearing as shown in the example output. 
...
Always only capitalize the first letter of the name when referring to any politician. 
